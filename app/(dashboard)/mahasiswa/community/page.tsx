...
export default function PlaceholderPage() {
    return (
        <div className="flex flex-col gap-6">
            <div>
                <h1 className="text-3xl font-bold tracking-tight">Komunitas & Diskusi</h1>
                <p className="text-muted-foreground mt-1">Diskusikan materi kelas dengan mahasiswa lain.</p>
            </div>
            <Card>
