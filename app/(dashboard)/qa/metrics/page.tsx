...
export default function PlaceholderPage() {
    return (
        <div className="flex flex-col gap-6">
            <div>
                <h1 className="text-3xl font-bold tracking-tight">Metrik Kualitas</h1>
                <p className="text-muted-foreground mt-1">Laporan metrik pembelajaran seluruh institusi.</p>
            </div>
            <Card>
