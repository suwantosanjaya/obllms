...
import { createCurriculumYear } from '@/app/actions/adminActions'

export function CreateCurriculumYearDialog() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        const res = await createCurriculumYear(name, startYear, endYear)
